...
def image_save(*args):
    ...
    for i in canvas.find_all():
        if canvas.type(i) == 'line':
            im_file.write('canvas.create_line('+str(canvas.coords(i))[1:-1]+',fill = "'+str(canvas.itemcget(i, 'fill'))+'",width='+str(canvas.itemcget(i, 'width'))+')\n')
        elif canvas.type(i) == 'rectangle':
            im_file.write('canvas.create_rectangle('+str(canvas.coords(i))[1:-1]+',fill = "'+str(canvas.itemcget(i, 'fill'))+'",width='+str(canvas.itemcget(i, 'width'))+',outline = "'+str(canvas.itemcget(i, 'outline'))+'")\n')
        elif canvas.type(i) == 'oval':
            im_file.write('canvas.create_oval('+str(canvas.coords(i))[1:-1]+',fill = "'+str(canvas.itemcget(i, 'fill'))+'",width='+str(canvas.itemcget(i, 'width'))+',outline = "'+str(canvas.itemcget(i, 'outline'))+'")\n')

        elif canvas.type(i) == 'polygon':
            im_file.write('canvas.create_polygon('+str(canvas.coords(i))[1:-1]+',fill = "'+str(canvas.itemcget(i, 'fill'))+'",width='+str(canvas.itemcget(i, 'width'))+',outline = "'+str(canvas.itemcget(i, 'outline'))+'")\n')
